...
import { initCsrf, save_department, get_users } from "@/services/api.js";
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <ul
            role="listbox"
            className="absolute z-50 mt-2 w-full rounded-md border border-neutral-800 bg-black text-white shadow-xl"
          >
            {options.map((opt) => (
...
export default function CreateDepartment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await save_department(payload);
      navigate("/super_dashboard/department");
    } catch (e) {
      console.error(e);
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6 text-white">
      ...
      <p className="text-neutral-400">Fill department details and (optionally) assign a director.</p>
