...
// Prefer env-configured backend; fall back to current origin
const API_BASE_URL =
...
export const show_contentSection = (id) =>
  api.get(`/api/show_contentSection/${id}`);
...
export const update_user = (id, payload) =>
  api.put(`/api/update_user/${id}`, payload);
